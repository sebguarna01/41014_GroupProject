# DoBot Robot Hand-Eye Calibration Project
...
* Move DoBot Magician Robot
* Capture Images
* Perform Camera Calibration

### Project Methodology
* **Extensive Research**: Investigated calibration techniques and project requirements.
* **Simulation**: Simulated robot movements to determine poses for calibration
* **Data Collection**: 
  * Installation
  * Checkerboard Mounting
  * Sensor Placement
  * DoBot Movement
* **Calibration Process**: Implemented detailed calibration methodology based on research findings.
